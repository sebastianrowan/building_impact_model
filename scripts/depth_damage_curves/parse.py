...
def parse_floorplan(plan):
    ...
    print(type(plan))
    plan['roof_area'] = calc_roof_area(plan.loc[:,'roof_length'], plan.loc[:,'roof_pitch'], plan.loc[:,'roof_height'], plan.loc[:,'ridge_height'], 999)
    ...
    components = [
        ...
        ('Bottom Outlets', 'structure', 'ea', 0, 'fail_count',  math.ceil(plan['int_wall_len1']/12), 1, 2, 1.5, 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 0, 0, 0, 0),
